...
CHANGED-PATHS: src/config/; src/historical/; scripts/poll_ibkr_latest.py; deploy/es-volregime-poller.service; docs/operations.md; tests/historical/
VALIDATION-SUMMARY: 82 tests passed; no executable 20:15 or hardcoded session-start boundary remains
COMMAND-EVIDENCE: TMPDIR=/tmp ./.venv/bin/pytest tests -q -> 82 passed; git diff --check -> clean; static boundary scan -> no matches
